...
public class Strings {
   ...
   //pelo código Ascii
    String texto =  "HELLO WORLD!";
    StringBuilder textoMinusculo = new StringBuilder();
    ...
    // Verifica se o caractere está entre 'A' e 'Z'
            if (c >= 'A' && c <= 'Z') {
                // Converte para minúscula somando 32
                textoMinusculo.append((char) (c + 32));    
            } else {
                // Mantém o caractere se não for maiúscula
                textoMinusculo.append(c);
            }
        }

        // Exibe o resultado
        System.out.println(textoMinusculo.toString());
    */
    }
