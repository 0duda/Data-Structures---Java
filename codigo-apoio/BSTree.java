...
public class BSTree<T extends Comparable<? super T>> {   
    ...
    //Devolve o menor valor armazenado na arvore
    public T minValue(){
    ...
    //Devolve o maior valor armazenado na arvore
    public T maxValue(){
   ...
   private int countBetween(T a, T b, BSTNode<T> node){
      if (node==null){
         return 0;
      }
      if(node.getValue().compareTo(a)<0){
         return countBetween(a, b, node.getRight());
      }
      else if (node.getValue().compareTo(a)>=0 && node.getValue().compareTo(b)<=0){
      return 1 + countBetween(a, b, node.getRight()) + countBetween(a, b, node.getLeft());
      }
      else{
         return countBetween(a,b, node.getLeft());
      }
   }
   ...
   private boolean valid(BSTNode<T> node, T min, T max){
      ...
      boolean leftvalid= valid(node.getLeft(), min ,value);
      boolean rightvalid= valid(node.getRight(), value, max);
   ...
   public static void main(String[] args) {
      ...
      System.out.println("t.countBetween(5,44) = " + t.countBetween(5, 44)); // 6
      System.out.println("t.countBetween(7,10) = " + t.countBetween(7, 10)); // 3
      System.out.println("t.countBetween(0,90) = " + t.countBetween(0, 90)); // 11
      System.out.println("t.countBetween(60,80) = " + t.countBetween(60, 80)); // 0
      System.out.println("t.countBetween(8,54) = " + t.countBetween(8, 54)); // 5
      System.out.println("t.countBetween(2,22) = " + t.countBetween(2, 22)); // 7
      System.out.println("t.countBetween(2,2) = " + t.countBetween(2, 2)); // 1
   }
